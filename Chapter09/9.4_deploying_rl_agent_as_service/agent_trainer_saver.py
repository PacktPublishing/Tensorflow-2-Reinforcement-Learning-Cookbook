#!/usr/bin/env python
# Train and Save PPO agent models in RL envs with image observations, continuous actions
...
parser = argparse.ArgumentParser(prog="TFRL-Cookbook-Ch5-SocialMedia-Mute-User-Agent")
...
if __name__ == "__main__":
    ...
    cta_agent.train(max_episodes=1)
    # Model saving
